...
This script is completely free to use! To use this, you need a Roblox executer, you can find the 
SUPPORTED ones *(DO NOT USE THE UNSUPPORTED ONES!!!)* in the Supported-Executers file 
